...
function translatePage(lang) {
  ...
  const translations = {
    fr: {
      ...
      "hero-subtitle":
        "Du 15 février au 13 avril 2025, l’exposition Trésors de Banlieues a accueilli plus de 17 000 visiteurs pour un événement unique, réunissant des œuvres issues de toutes les banlieues de France.",
    ...
    en: {
      ...
      "hero-subtitle":"From February 15 to April 13, 2025, Trésors de Banlieues welcomed over 17,000 visitors for a unique celebration of contemporary urban art.",
      ...
      "popular-text-1":
        "Elderly people, schoolchildren, suburban residents, foreigners... Once again this year, the exhibition managed to reach an extremely wide audience, composed of all social and geographical categories. With its 17,000 visitors, the 2025 edition of Trésors de Banlieues was a resounding success, both for the organizers and for the suburb itself, bringing together all populations through art in all its forms. For Manuel Alvarez, it is this diversity of works and visitors that represents the suburb:",
      "popular-text-2":
    ...
    es: {
      ...
      "hero-subtitle":
        "Del 15 de febrero al 13 dee abril de 2025, Trésors de Banlieues recibió a más de 17.000 visitantes para una celebración única del arte urbano contemporáneo.",
    ...
    ja: {
      ...
      "hero-subtitle":
        "2025年2月15日から4月13日まで、「トレゾール・ド・バンリュー」は現代都市アートの特別な祭典に17,000人以上の訪問者を迎えました。",
      ...
      "popular-text-1":
        "高齢者、学生、郊外の住民、外国人...今年も展示会は、あらゆる社会的・地理的カテゴリーで構成された非常に幅広い観客に到達することができました。17,000人の訪問者を迎えた2025年版の「トレゾール・ド・バンリュー」は、主催者にとっても郊外自体にとっても大成功でした。あらゆる形のアートを通じてすべての人々を結びつけました。マニュエル・アルバレスにとって、郊外を代表するのはこの作品と訪問者の多様性です：",
      "popular-text-2":
