...
function translateEquipePage(lang) {
  ...
  const translations = {
    fr: {
      ...
      "value-desc-1":
        "Cette valeur a permis à chaque membre de l'équipe d'exprimer son imagination en favorisant un environnement où chacun peut proposer ses idées librement.",
    ...
    en: {
      ...
      "team-desc-6": "Having designed the sketch as well as some of the basics of the site, Alvin was creative while maintaining a logical approach, allowing the site to be in harmony with the event and its visual identity. Through effective collaboration with other members of the group, highlight their skills and contribute fully to this project.",
    ...
    es: {
      ...
      "hero-subtitle": "Descubre el equipo que llevó a cabo este proyecto en Trésors de Banlieues !",
      ...
      "team-desc-6": "Habiendo diseñado el boceto y algunas de las bases del sitio, Alvin fue creativo al tiempo que mantuvo un enfoque lógico, permitiendo que el sitio estuviera en armonía con el evento y su identidad visual. Mediante una colaboración eficaz con los demás miembros del grupo, poner de relieve sus competencias y contribuir plenamente a este proyecto.",
    ...
    ja: {
      ...
      "team-desc-6": "スケッチとサイトの基本のいくつかを設計した Alvin は、論理的なアプローチを維持しながら創造的であり、サイトがイベントとその視覚的アイデンティティと調和することを可能にしました。グループの他のメンバーとの効果的なコラボレーションを通じて、彼らのスキルを強調し、このプロジェクトに全面的に貢献します。",
