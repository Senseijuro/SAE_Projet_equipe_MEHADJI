...
function translateIndexPage(lang) {
  ...
  const translations = {
    fr: {
      ...
      "about-text-2":
        " À travers cette édition 2026, nous mettons en avant des artistes qui façonnent et réinventent les espaces urbains au sein des banlieues. Pour cette édition 83 communes ont répondu à l’appel et se sont prises au jeu. Entre graffitis, statues, photographies et tableaux, tout est réuni pour passer un bon moment en immersion au cœur de nos banlieues.",
